...
> **Hugo 0.93.x Note:** Tested up to/with [Hugo 0.93.2 extended](https://github.com/gohugoio/hugo/releases/tag/v0.93.2). If you get `stack exceeds` error check you markdown ULR, `[https://github.com](https://github.com)` trows an error, but `[github.com](https://github.com)` works fine.
